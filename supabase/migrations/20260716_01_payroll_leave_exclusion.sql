-- 休職(employee_leaves + exclusion_target='payroll')の従業員を「消さずに0で残す」
-- 判定は fn_employment_status_in_period(3社共通) を呼ぶ。ロジック二重管理しない。
