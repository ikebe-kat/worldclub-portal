-- 退職日(resigned_at)で給与計算の対象者を判定する
-- employee_idがある人 → employees.resigned_at >= v_period_start なら含める
-- employee_idがNULLの純給与レコード → 従来通り wc_payroll_settings.is_active で制御
